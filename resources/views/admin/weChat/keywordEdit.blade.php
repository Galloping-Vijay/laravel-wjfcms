    ...
    <div class="layui-form" lay-filter="layuiadmin-app-list" id="layuiadmin-app-form-list"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="key_name" value="{{ $info->key_name }}" lay-verify="required" placeholder="请输入" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <textarea name="key_value" class="layui-textarea">{{ $info->key_value }}</textarea>
            </div>
        </div>
        <div class="layui-form-item">
